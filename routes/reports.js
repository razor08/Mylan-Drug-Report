...
function saveMessage(mid, message) {
    var x = message;
...
//         } else {
//             bdy = JSON.parse(bdy);
//             console.log(bdy['messages']);
//             var p = '+917892727758';
//             var p2 = '+918090167640';
//             if (bdy['messages'][0]['body'][0] == '|') {
//                 if (bdy['messages'][0]['address'] == p || bdy['messages'][0]['address'] == p2) {
//                     reports.findOne({"mid": bdy['messages'][0]['_id']}, function (e, foundReport) {
//                         if (functions.isEmpty(foundReport)) {
//                             console.log(bdy['messages'][0]['body']);
//                             saveMessage(bdy['messages'][0]['_id'], bdy['messages'][0]['body']);
//                         }
//                     });
//
//                 }
...
router.get("/reports/refresh",function(req, res){
    ...
    var x = '|Hemant|Joshi|261298|0|56|12306-200934-somthing awesome|200118|200218|I took Paracetamol and I had drowsy feeling after consuming 500mg of it|||Paracetamol-500-Novartis|2-bid-oral|200118-100218|fever|0|1234-200120|0|I took turmeric with honey||113 MSR_101|010318|0|Student|'
...
router.get("/reports/refresh1",function(req, res){
    // var x = '|Hemant|Joshi|261298|0|56|12306-200934-somthing fucked|200118|200218|I took Paracetamol and I had drowsy feeling after consuming 500mg of it|||Paracetamol-500-Novartis|2-bid-oral|200118-100218|fever|0|1234-200120|0|I took turmeric with honey||113 MSR_101|010318|0|Student|'
    var x = '|V R|Karthik|141018|0|56|236-200934-somthing awesome|200118|200218|I took Paracetamol and I had drowsy feeling after consuming 500mg of it|||Paracetamol-500-Novartis|2-bid-oral|200118-100218|fever|0|1234-200120|0|I took turmeric with honey||113 MSR_101|010318|0|Student|'
